! function(t) {
    ...
    }, e.n = function(t) { var n = t && t.__esModule ? function() { return t.default } : function() { return t }; return e.d(n, "a", n), n }, e.o = function(t, e) { return Object.prototype.hasOwnProperty.call(t, e) }, e.p = "/", e(e.s = 38)
}([function(t, e, n) {
    "use strict";
    ...
    function a(t) {!t._dirty && (t._dirty = !0) && 1 == H.push(t) && (E.debounceRendering || U)(s) }

    function s() { var t, e = H; for (H = []; t = e.pop();) t._dirty && M(t) }
    ...
    function m(t) { return this._listeners[t.type](E.event && E.event(t) || t) }

    function y() { for (var t; t = R.pop();) E.afterMount && E.afterMount(t), t.componentDidMount && t.componentDidMount() }

    function v(t, e, n, r, o, i) { L++ || (q = null != o && void 0 !== o.ownerSVGElement, I = null != t && !("__preactattr_" in t)); var a = b(t, e, n, r, i); return o && a.parentNode !== o && o.appendChild(a), --L || (I = !1, i || y()), a }
        ...
        if (0 !== x)
            for (var w = 0; x > w; w++) {
                ...
                if (null != T) m && void 0 !== h[T] && (p = h[T], h[T] = void 0, m--);
                    ...
                    for (i = y; g > i; i++)
                        if (void 0 !== d[i] && c(a = d[i], u, o)) { p = a, d[i] = void 0, i === g - 1 && g--, i === y && y++; break }
    ...
    function w(t, e, n) { var r; for (r in n) e && null != e[r] || null == n[r] || d(t, r, n[r], n[r] = void 0, q); for (r in e) "children" === r || "innerHTML" === r || r in n && e[r] === ("value" === r || "checked" === r ? t[r] : n[r]) || d(t, r, n[r], n[r] = e[r], q) }
    ...
    function T(t, e, n) { return this.constructor(t, n) }

    function j(t, e, n, r, o) { t._disable || (t._disable = !0, (t.__ref = e.ref) && delete e.ref, (t.__key = e.key) && delete e.key, !t.base || o ? t.componentWillMount && t.componentWillMount() : t.componentWillReceiveProps && t.componentWillReceiveProps(e, r), r && r !== t.context && (t.prevContext || (t.prevContext = t.context), t.context = r), t.prevProps || (t.prevProps = t.props), t.props = e, t._disable = !1, 0 !== n && (1 !== n && !1 === E.syncComponentUpdates && t.base ? a(t) : M(t, 1, o)), t.__ref && t.__ref(t)) }
    ...
    function N(t, e, n, r) { for (var o = t && t._component, i = o, a = t, s = o && t._componentConstructor === e.nodeName, c = s, u = p(e); o && !c && (o = o._parentComponent);) c = o.constructor === e.nodeName; return o && c && (!r || o._component) ? (j(o, u, 3, n, r), t = o.base) : (i && !s && (S(i), t = a = null), o = C(e.nodeName, u, n), t && !o.nextBase && (o.nextBase = t, a = null), j(o, u, 1, n, r), t = o.base, a && t !== a && (a._component = null, _(a, !1))), t }
    ...
    function A(t, e) { this._dirty = !0, this.context = e, this.props = t, this.state = this.state || {} }

    function P(t, e, n) { return v(n, t, {}, !1, e, !1) }
    n.d(e, "b", function() { return o }), n.d(e, "a", function() { return A }), n.d(e, "c", function() { return P });
    var E = {},
        k = [],
        D = [],
    ...
    i(A.prototype, {
        ...
        forceUpdate: function(t) { t && (this._renderCallbacks = this._renderCallbacks || []).push(t), M(this, 2) },
        render: function() {}
    })
}, function(t, e, n) {
    "use strict";
    ...
    t.exports = function(t) {
        return new Promise(function(e, p) {
            ...
            var d = new XMLHttpRequest,
                ...
                m = !1;
            if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in d || s(t.url) || (d = new window.XDomainRequest, h = "onload", m = !0, d.onprogress = function() {}, d.ontimeout = function() {}), t.auth) { f.Authorization = "Basic " + u((t.auth.username || "") + ":" + (t.auth.password || "")) }
            if (d.open(t.method.toUpperCase(), i(t.url, t.params, t.paramsSerializer), !0), d.timeout = t.timeout, d[h] = function() {
                ...
                }, d.onerror = function() { p(c("Network Error", t, null, d)), d = null }, d.ontimeout = function() { p(c("timeout of " + t.timeout + "ms exceeded", t, "ECONNABORTED", d)), d = null }, r.isStandardBrowserEnv()) {
                var y = n(21),
                    v = (t.withCredentials || s(t.url)) && t.xsrfCookieName ? y.read(t.xsrfCookieName) : void 0;
                v && (f[t.xsrfHeaderName] = v)
            }
            if ("setRequestHeader" in d && r.forEach(f, function(t, e) { void 0 === l && "content-type" === e.toLowerCase() ? delete f[e] : d.setRequestHeader(e, t) }), t.withCredentials && (d.withCredentials = !0), t.responseType) try { d.responseType = t.responseType } catch (e) { if ("json" !== t.responseType) throw e }
            "function" == typeof t.onDownloadProgress && d.addEventListener("progress", t.onDownloadProgress), "function" == typeof t.onUploadProgress && d.upload && d.upload.addEventListener("progress", t.onUploadProgress), t.cancelToken && t.cancelToken.promise.then(function(t) { d && (d.abort(), p(t), d = null) }), void 0 === l && (l = null), d.send(l)
        })
    }
}, function(t, e, n) {
    "use strict";
    ...
    e.a = function(t) {
        ...
        return o(e, t), e.prototype.componentDidMount = function() {
            var t = this;
            setTimeout(function() { t.state.visible = !0, t.state.visibilityChanged = !0, t.onVisibilityChange(), t.props.onVisibilityChange(t.props.message, t.state) }, this.props.timeout || 0)
        }, e
    }(r.a)
}, function(t, e, n) {
    "use strict";
    ...
    var o = n(0),
        ...
        s = n(2),
        c = r(s);
    c.Axios = a, c.create = function(t) { return r(o.merge(s, t)) }, c.Cancel = n(7), c.CancelToken = n(27), c.isCancel = n(6), c.all = function(t) { return Promise.all(t) }, c.spread = n(28), t.exports = c, t.exports.default = c
}, function(t) {
    ...
    if (u) try { c = JSON.parse(u) } catch (t) {}
}, function(t, e, n) {
    "use strict";
    var r = n(1),
        o = n(40),
    ...
    e.a = function(t) {
        ...
        return a(e, t), e.prototype.componentDidMount = function() { var t = this;!this.state.messages.length && this.props.conf.introMessage && this.writeToMessages({ text: this.props.conf.introMessage, type: "text", from: "chatbot" }), window.addEventListener("message", function(e) { try { t[e.data.method].apply(t, e.data.params) } catch (t) {} }) }, e.prototype.sayAsBot = function(t) { this.writeToMessages({ text: t, type: "text", from: "chatbot" }) }, e.prototype.say = function(t, e) {
            ...
            this.botman.callAPI(r.text, !1, null, function(t) { t.from = "chatbot", n.writeToMessages(t) }), e && this.writeToMessages(r)
    ...
    e.a = function(t) {
        ...
        return a(e, t), e.prototype.render = function(t) {
            ...
            var e = this;
            o.a.callAPI(t.value, !0, null, function(t) { e.state.attachmentsVisible = !1, e.props.messageHandler({ text: t.text, type: t.type, timeout: t.timeout, actions: t.actions, attachment: t.attachment, additionalParameters: t.additionalParameters, from: "chatbot" }) }, null)
        }, e
    }(i.a)
}, function(t, e, n) {
    "use strict";
    ...
    e.a = function(t) {
        function e() { var e = null !== t && t.apply(this, arguments) || this; return e.onVisibilityChange = function() { setTimeout(function() { e.state.visible = !1, e.props.onVisibilityChange(e.props.message, e.state) }, 1e3 * e.props.message.timeout) }, e }
    ...
    e.a = function(t) {
        ...
        return a(e, t), e.prototype.render = function(t) {
            ...
            var e = this;
            o.a.callAPI(t.payload, !0, null, function(t) { e.state.attachmentsVisible = !1, e.props.messageHandler({ text: t.text, type: t.type, actions: t.actions, attachment: t.attachment, additionalParameters: t.additionalParameters, from: "chatbot" }) }, null)
        }, e
    }(i.a)
}]);